...
public class Dept {
    ...
    @Url("DeptGetId")
    public ModelView myMethodId(@Argument("nom") String nom, @Argument("prenom") String prenom,
            @Argument("age") int age, @Argument("date") Date date, @Argument("lieu") String lieu,
            @Argument("poids") double poids, @Argument("time") Time time) {
        String s1 = ".jsp";
        String s = "Liste";
        String vString = s + s1;
        ModelView m = new ModelView(vString);
    ...
    @Url("DeptsaveFile")
    public ModelView myMethodSaveFile(@Argument(value = "nom") String nom, @Argument(value = "file") FileUpload file) {
        String s1 = ".jsp";
        String s = "Liste";
        String vString = s + s1;
        ModelView m = new ModelView(vString);
        ArrayList<Dept> olona = new ArrayList<Dept>();
        Dept user = new Dept(nom, file);
        System.out.println("Ato anaty dept : " + file);
        olona.add(user);
        m.add("Fichier", olona);
        return m;
    }
